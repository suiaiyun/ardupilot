...
#elif HAL_INS_DEFAULT == HAL_INS_MPU60XX_I2C && HAL_INS_MPU60XX_I2C_BUS == 1
    _add_backend(AP_InertialSensor_MPU6000::detect_i2c(*this, hal.i2c1, HAL_INS_MPU60XX_I2C_ADDR));
