...
#ifndef __AP_HAL_ELFINAAT_I2CDRIVER_H__
#define __AP_HAL_ELFINAAT_I2CDRIVER_H__

#include "AP_HAL_ELFINAAT.h"

#include <i2c.h>

class AP_HAL_ELFINAAT_NS::ELFINAATI2CDriver : public AP_HAL::I2CDriver {
public:
    ELFINAATI2CDriver(AP_HAL::Semaphore* semaphore);
    void begin();
    void end();
...
#endif // __AP_HAL_ELFINAAT_I2CDRIVER_H__
